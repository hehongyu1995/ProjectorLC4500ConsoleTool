...
int ProjectorOpenGL::setExplosureFramePeriod(unsigned int exposurePeriod, unsigned int framePeriod){}
int ProjectorOpenGL::setPatternTriggerMode(bool internal){}
int ProjectorOpenGL::setPatternDisplayMode(bool videoInput){}
int ProjectorOpenGL::setVideoMode(){}
int ProjectorOpenGL::setSLMode(){}
int ProjectorOpenGL::setStandByMode(){}
int ProjectorOpenGL::playSeq(){}
